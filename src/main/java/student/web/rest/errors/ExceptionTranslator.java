package student.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(student.service.EmailAlreadyUsedException ex, NativeWebRequest request) {
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        student.service.UsernameAlreadyUsedException ex,
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleInvalidPasswordException(student.service.InvalidPasswordException ex, NativeWebRequest request) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "student");
    }
}
